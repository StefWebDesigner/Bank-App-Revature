...
public class ClientInformationRepo implements DataSourceCRUD<ClientInformationModel> {
    ...
    public Integer create(ClientInformationModel clientInformationModel) throws SQLException, IOException {
...
//        pstmt.setInt(1, createMenuPogo.getId());
    ...
    @Override
    public ClientInformationModel read(Integer id) throws SQLException, IOException {
    ...
    public ClientInformationModel update(ClientInformationModel clientInformationModel) throws SQLException, IOException {
...
//                }
    ...
    public ClientInformationModel authenticate(String username, String password) throws SQLException, IOException {
        ...
        if (rs.next()) {// if this is true, then we have a matching user/pass in our result set, so the user is authenticated //temp took out
            ...
            ClientInformationModel user = new ClientInformationModel();
