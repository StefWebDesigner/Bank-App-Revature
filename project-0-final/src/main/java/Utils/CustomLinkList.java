...
//     */
//    @Override
//    public void add(E e) { //SETTING  HEAD AND TAAIL REFERENCES
...
//        }
//
//        tail.next = newNode; //THE SLICING OF THE NODES
//        newNode.prev = tail;
//        tail = newNode;
//        size++;
//    }
...
//     */
//    @Override
//    public E get(int index) { //changing the refercen poins from past node to the next new node
//        Node<E> cursor = head;
//        for (int i = 0; i < index; i++) {
//            cursor = cursor.next; //this is the references it is the next node
//        }
//
//        return cursor.obj; //the payload of the cursor
//    }
//
//    /**
