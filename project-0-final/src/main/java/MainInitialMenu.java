...
//            the order of the parameter in this make the differenece >>> %$%copy this over
            CreateMenuPogo testObj = new CreateMenuPogo(username, password, firstName, lastName, email, country, addressStreet, addressState, addressZipCode);
...
//            repo.create(newUser);
            ...
            ContextStore.setCurrentUser(testObj);
